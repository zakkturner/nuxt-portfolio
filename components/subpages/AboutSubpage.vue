        ...
        <div class="section-inner">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
              ...
              <p>I am a Javascript developer with experience working on high visibility applications with companies, such as Delta Airlines and Sean “Puffy'' Combs' Combs Enterprises. I focus on front end frameworks such as React and Angular.</p>
              <p>I have a passion for Creative Development (GSAP and Three.js), Web Performance, Ecommerce Development, Web Accessibility, and headless JAM stack (Javascript, API’s, Markup) Applications. To grow my skills I focus on building a JAMstack application for a developer community called Interactive Nerd, practice game dev with C# and Unity as a hobby and occasionally freelance to help small businesses in my community.</p>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 subpage-block">
              <ul class="info-list">
                ...
                <li><span class="title">Address</span><span class="value">Atlanta, GA</span></li>
                <li><span class="title">E-Mail</span><span class="value"><a href="mailto:email@example.com">zakkturner1993@gmail.com</a></span></li>
                <li><span class="title">Phone</span><span class="value">317-728-0446</span></li>
...
import Press from '../about/Press.vue';
</script>
<style lang="">
